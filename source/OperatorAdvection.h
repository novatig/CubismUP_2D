...
public:
	...
	OperatorAdvectionFD(double dt, const int stage) : dt(dt), uBody(NULL), vBody(NULL)
	{
		stencil_start[0] = -1;
		stencil_start[1] = -1;
		stencil_start[2] = 0;
...
public:
    OperatorAdvectionUpwind3rdOrder(double dt, Real * uBody, Real * vBody, const int stage)
	: dt(dt), uBody(uBody), vBody(vBody), stage(stage)
    {
        stencil_start[0] = -2;
        stencil_start[1] = -2;
        stencil_start[2] = 0;
    ...
    OperatorAdvectionUpwind3rdOrder(double dt, const int stage)
    : dt(dt), uBody(NULL), vBody(NULL), stage(stage)
    {
        stencil_start[0] = -2;
        stencil_start[1] = -2;
        stencil_start[2] = 0;
